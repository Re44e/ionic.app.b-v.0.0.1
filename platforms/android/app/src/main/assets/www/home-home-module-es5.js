...
var HomePage = /** @class */ (function () {
    function HomePage(router, todoService, route, alertController, menu) {
        this.router = router;
    ...
    HomePage.prototype.dateSelected = function (event) {
    ...
    HomePage.prototype.loadTodo = function () {
        var _this = this;
        this.todoService.getTodo(this.todoId).subscribe(function (res) {
            _this.todo = res;
        });
    };
    HomePage.prototype.presentAlertConfirmDelete = function (item) {
                            ...
                            buttons: [
                                {
                                    ...
                                    text: 'Excluir',
                                    handler: function () {
                                        _this.todoService.removeTodo(item.id);
                                    }
                                }
                            ]
                        })];
    ...
    HomePage.prototype.editarTodo = function (register) {
        var _this = this;
        this.idRegister = register;
        this.todoService.getTodo(register).subscribe(function (res) {
            _this.todo = res;
            _this.editar = true;
        });
        this.editar = false;
    ...
    HomePage.prototype.saveTodo = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.idRegister) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.todoService.updateTodo(this.todo, this.idRegister).then(function () {
                            })];
                    case 1:
                        _a.sent();
                        this.back();
